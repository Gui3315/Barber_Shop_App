...
class ScheduleMalePage extends StatefulWidget {
  final String userName;
  final String userEmail;

  const ScheduleMalePage({
    super.key,
  ...
  @override
  State<ScheduleMalePage> createState() => _ScheduleMalePageState();
}

class _ScheduleMalePageState extends State<ScheduleMalePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return BackgroundContainer(
      child: Scaffold(
        ...
        body: Stack(
          children: [
            // Fundo escuro com opacidade em toda tela
            Positioned.fill(
